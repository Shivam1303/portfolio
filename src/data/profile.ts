export const profileData = {
  ...
  freelancingExperience: [
    ...
    },
    {
      ...
      description: 'Created high-performance, SEO-optimized landing pages for various clients',
      features: [
  ...
  openSourceContributions: [
    {
      ...
      description:
        'Developed & published a suite of scalable UI components for modern web apps, enhancing performance & UX.',
