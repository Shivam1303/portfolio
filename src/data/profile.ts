export const profileData = {
    ...
    workExperience: [
        ...
        },
        {
            ...
            achievements: [
                "Developed and optimized an e-commerce Progressive Web App (PWA) with Adobe PWA Studio, reducing page load times by 30%.",
                "Integrated GraphQL queries and mutations, improving API response efficiency..",
                "Implemented dynamic PDF generation and certificate templates, increasing client customization efficiency by 50% and reducing template setup time..",
                "Migrated a web application from Angular 13 to 17, modernizing API integrations and reducing load times by 40% (from 8s to 4.s).",
            ]
        }
    ],
    education: [
    ...
    skills: [
        ...
        },
        {
            ...
            items: ["Node.js", "React", "Next.js", "Angular", ".NET Core", ".NET Framework", "Entity Framework", "Adobe PWA Studio"]
        },
        {
            category: "Databases",
            items: ["MySQL", "MSSQL", "PostgreSQL", "Google BigQuery", "MongoDB", "Firebase"]
        },
        {
            category: "Other Tools",
            items: ["GraphQL", "REST APIs", "Webpack", "Redux", "Git", "Agile Development", "NPM Package Development"]
        }
    ],
    openSourceContributions: [
        {
            title: "Fleek UI Components (NPM Packages)",
            description: "Developed & published a suite of scalable UI components for modern web apps, enhancing performance & UX.",
    ...
    projects: [
        {
            ...
            description: "Designed and published a type utility library for TypeScript, simplifying deep object type management. Provides schema validation, deep type transformations, and type utilities, improving developer experience in TypeScript projects.",
            link: {
        ...
        {
            title: "URL Shortener",
            description: "Built a URL shortening service using Node.js and MySQL, optimizing query performance by 30%.",
            link: {
